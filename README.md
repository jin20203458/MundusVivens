...
- [04_profiling_and_optimization.md](https://github.com/jin20203458/Obsidian.Agent/blob/main/MundusVivens/docs/04_profiling_and_optimization.md): Tracy 프로파일러 연동 및 4대 벤치마크 검증 보고서

> **참고**:
 전체 시스템 구성도 및 흐름도는 중복을 방지하기 위해 [00_project_overview.md](https://github.com/jin20203458/Obsidian.Agent/blob/main/MundusVivens/docs/00_project_overview.md)에서만 제공합니다.
